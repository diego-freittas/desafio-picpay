...
import br.gov.com.diegofreitas.desafiopicpay.domain.enuns.UserStatus;
import br.gov.com.diegofreitas.desafiopicpay.domain.enuns.UserType;
...
import br.gov.com.diegofreitas.desafiopicpay.dtos.JwtDto;
import br.gov.com.diegofreitas.desafiopicpay.dtos.LoginDto;
import br.gov.com.diegofreitas.desafiopicpay.dtos.UserDto;
import br.gov.com.diegofreitas.desafiopicpay.infra.security.JwtProvider;
...
public class AuthenticationController {
    ...
    public ResponseEntity<Object> registerUserAdmin(@RequestBody @Validated(UserDto.UserView.RegistrationPost.class)
        ...
        Role roleModel = roleService.findByRoleName(RoleType.ROLE_ADMIN)
                .orElseThrow(() -> new RuntimeException("Error: Role is Not Found."));
        userDto.setPassword(passwordEncoder.encode(userDto.getPassword()));
        var userModel = new User();
        BeanUtils.copyProperties(userDto, userModel);
